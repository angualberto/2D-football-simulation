...
int main() {
	...
	FILE *fp=safe_fopen("../../data/liq-900K.dat","r"),*fp2,*fp3;
	...
	fp=safe_fopen("../../output/liq-900K.out","w");
	fp2=safe_fopen("../../output/liq-900K.gnu","w");
	fp3=safe_fopen("../../output/liq-900K-orig.gnu","w");
